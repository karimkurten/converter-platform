          ...
          <div className="col-span-2 md:col-span-4 lg:col-span-1">
            ...
            <div className="flex items-center gap-3 mt-4">
              <a
                ...
                className="w-8 h-8 rounded-lg bg-gray-100 dark:bg-gray-800 hover:bg-red-50 dark:hover:bg-red-900/30 text-gray-400 hover:text-red-600 dark:hover:text-red-400 flex items-center justify-center transition-colors"
                aria-label="Follow ConvertNow on Pinterest"
                title="Follow ConvertNow on Pinterest"
              >
